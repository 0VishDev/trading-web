...
<body class="goto-here">
                ...
                <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services mb-md-0 mb-4">
                        ...
                        <div class="media-body">
                            <h3 class="heading">Transportation Facility</h3>
    ...
    <section class="ftco-section ftco-category ftco-no-pt">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/about/3.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0"><a href="#">Leather Purse</a></h2>
                        </div>
                    </div>
                    <div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(images/about/4.jpg);">
                        <div class="text px-3 py-1">
                            <h2 class="mb-0"><a href="#">Leather Purse</a></h2>
                        </div>
                    </div>
    ...
    <section class="ftco-section img" style="background-image: url(images/background.jpeg);">
        <div class="container">
